...
---
## 一、LangChain4j AI顾问
**<font style="color:rgb(0,0,0);">- </font>**<font style="color:rgb(0,0,0);">设计并实现分层多轮会话管理机制，基于Redis构建短期记忆，MySQL实现中期记忆和长期记忆，支持会话列表管理。</font>

<font style="color:rgb(0,0,0);">- </font><font style="color:rgb(0,0,0);">构建</font><font style="color:rgb(0,0,0);">RAG</font><font style="color:rgb(0,0,0);">架构知识库，实现商家信息的自动向量化处理和定期更新，提升语义检索准确性。</font>

<font style="color:rgb(0,0,0);">- </font><font style="color:rgb(0,0,0);">开发</font><font style="color:rgb(0,0,0);">Function Calling</font><font style="color:rgb(0,0,0);">工具集，实现商家信息查询、预约下单等业务功能与大模型的无缝集成。</font>
